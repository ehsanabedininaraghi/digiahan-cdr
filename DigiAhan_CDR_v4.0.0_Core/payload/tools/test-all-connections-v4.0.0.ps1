...
$textReport = Join-Path $logRoot "MVP-v4.0.0-$stamp.txt"
$jsonReport = Join-Path $logRoot "MVP-v4.0.0-$stamp.json"
...
$lines = @()
$lines += "DigiAhan MVP Connectivity v4.0.0"
