...
public sealed class DashboardRepository
{
    ...
    public async Task<SyncStatus> Sync(CancellationToken ct)
    {
        ...
        DateTime? started = null, finished = null, lastReceived = null;
        ...
        if (await reader.ReadAsync(ct))
        {
            ...
            rowsLastHour = reader.IsDBNull(1) ? 0 : Convert.ToInt32(reader[1]);
        }

        return new SyncStatus(started, finished, batchStatus, inserted, duplicates, errors, lastReceived, rowsLastHour);
    }
