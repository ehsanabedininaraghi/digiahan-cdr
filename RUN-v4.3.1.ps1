...
try {
    ...
    $dataConfig.DataGathering | Add-Member -MemberType NoteProperty -Name IncrementalAccountingDays -Value 7 -Force
    $dataConfig.DataGathering | Add-Member -MemberType NoteProperty -Name AccountingDays -Value 60 -Force
    ...
    $dataConfig.DataGathering | Add-Member -MemberType NoteProperty -Name AccountingBridgeScript -Value "tools/accounting-bridge-v4.3.1.ps1" -Force
