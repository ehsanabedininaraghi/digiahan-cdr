...
$textReport = Join-Path $logRoot "MVP-v3.7.4-$stamp.txt"
$jsonReport = Join-Path $logRoot "MVP-v3.7.4-$stamp.json"
...
$lines = @()
$lines += "DigiAhan MVP Connectivity v3.7.4"
