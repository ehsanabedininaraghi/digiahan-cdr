...
public sealed class CustomerIdentityReconcileService
{
    ...
    public async Task<CustomerIdentityStatus> ReconcileAsync(CancellationToken ct)
    {
        ...
        await EnsureMasterIdentityColumnsAsync(connection, ct);
    ...
    private static async Task EnsureMasterIdentityColumnsAsync(SqlConnection connection, CancellationToken ct)
    {
        const string sql = """
