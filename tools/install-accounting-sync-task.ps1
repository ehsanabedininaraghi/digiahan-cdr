...
$bridge = Join-Path $RepositoryRoot "tools\accounting-bridge-v3.7.ps1"
if (-not (Test-Path $bridge)) {
    throw "Accounting bridge not found: $bridge"
}

$taskName = "DigiAhan Accounting Bridge v3.7"
...
Register-ScheduledTask `
    ...
    -Settings $settings `
    -Principal $principal `
    -Description "Sync legacy SQL Server 2000 accounting data and rebuild customer identity every $EveryMinutes minutes." `
    -Force | Out-Null
