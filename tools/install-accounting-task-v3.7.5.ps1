...
$bridge = Join-Path $RepositoryRoot "tools\accounting-bridge-v3.7.5.ps1"
if (-not (Test-Path $bridge)) {
    throw "Accounting bridge not found: $bridge"
}

$taskName = "DigiAhan Accounting Bridge v3.7.5"
...
Register-ScheduledTask `
    ...
    -Settings $settings `
    -Principal $principal `
    -Description "Direct ADODB accounting sync for DigiAhan v3.7.5." `
    -Force | Out-Null
