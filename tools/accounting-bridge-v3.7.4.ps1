...
try {
    Write-Host "Accounting Bridge v3.7.4" -ForegroundColor Cyan
...
"@
    ...
    Write-Host "[5/6] Accounting synchronization completed successfully against the real schema." -ForegroundColor Green
